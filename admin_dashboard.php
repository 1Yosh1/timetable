...
<div class="sidebar text-center">
    <img src="images/logo.png" alt="UniMe Logo" style="height: 60px; margin-bottom: 15px; max-width: 80%; object-fit: contain;">
    ...
    <ul class="collapse list-unstyled <?php echo $is_management_active?'show':''; ?>" id="managementSubmenu">
        ...
        <li><a href="admin_dashboard.php?page=schedule_requests" class="<?php echo ($current_sub_page=='schedule_requests')?'active':''; ?>">Schedule Requests</a></li>
